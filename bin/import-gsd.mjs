...
`;
  ...
  return (
    <div>
      ...
      {tab === 'custom' ? <CustomSection wcc={wcc} /> : <GsdPlanView wcc={wcc} />}
    </div>
  );
}`
    : `function Page({ wcc }) { return <GsdPlanView wcc={wcc} />; }`;
...
function main() {
  ...
  // (defines `function CustomSection({ wcc })`; optional `// @tab: <label>` directive sets the
  ...
  // The custom code shares the generated module's scope (C, useState, the wcc prop) — its own
